function [] = h_error_Strehl_Ratio(N)
%% ******************************************************************** %%
...
%% *************************************************************** %%
format long
x = linspace(1e-9,3e-9,300);    %  wavelength
y = linspace(5e-3,15e-3,300)';  %  grazing angle
[X,Y] = meshgrid(x,y);
...
x = linspace(1e-9,3e-9,300);    %  wavelength
y1 = 5e-3;                      %  grazing angle
y2 = 10e-3;                     %  grazing angle
y3 = 15e-3;                     %  grazing angle
...
set(gca,'TickLabelInterpreter','latex','fontsize',20,'linewidth',1.5);
set(get(gca,'Children'),'linewidth',2);
legend({'$\alpha$ = 5mrad','$\alpha$ = 10mrad','$\alpha$ = 15mrad'}...

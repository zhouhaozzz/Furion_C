function Grazing_str = Furion_grazing_incident(gra_theta,phot_Energy,atomic_sym,path_Str,flag_sp)
%% ************************************************************** %%
...
n_Refraction_str = Furion_complex_refraction(phot_Energy,atomic_sym,path_Str);

function  S3FEL_beam_size_FEL2_M1()
%% ******************************************************************** %%
...
figure;
subplot(1,2,2);
plot(wave_Lambda(1:4)*1e9,2*out_SigmaI(1:4)*1e3/sin(8.73e-3))      % 2sigma
hold on
plot(wave_Lambda(1:4)*1e9,4*out_SigmaI(1:4)*1e3/sin(8.73e-3))      % 2sigma
hold on
plot(wave_Lambda(1:4)*1e9,6*out_SigmaI(1:4)*1e3/sin(8.73e-3))      % 2sigma
...
subplot(1,2,1);
plot(wave_Lambda(3:end)*1e9,2*out_SigmaI(3:end)*1e3/sin(17.45e-3))      % 2sigma
hold on
plot(wave_Lambda(3:end)*1e9,4*out_SigmaI(3:end)*1e3/sin(17.45e-3))      % 2sigma
hold on
plot(wave_Lambda(3:end)*1e9,6*out_SigmaI(3:end)*1e3/sin(17.45e-3))      % 2sigma

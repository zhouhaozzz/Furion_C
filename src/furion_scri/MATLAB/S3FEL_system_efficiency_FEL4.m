function S3FEL_system_efficiency_FEL4()
%% ******************************************************************** %%
...
gra_theta1 = 10-3;
Grazing_str1 = Furion_grazing_incident(gra_theta1,phot_Energy,'C',path_Str,1); % M1,M2
gra_theta2 = 20e-3;
Grazing_str2 = Furion_grazing_incident(gra_theta2,phot_Energy,'C',path_Str,1); % M3,M4
gra_theta3 = 17.45e-3;
Grazing_str3 = Furion_grazing_incident(gra_theta3,phot_Energy,'C',path_Str,1); % M3,M4


%% *************************************************************** %%
%                                                                %
reflectivity1 = (Grazing_str2.R_intensity).^7;    % 极紫外光学标定
reflectivity2 = (Grazing_str2.R_intensity).^6.*Grazing_str3.R_intensity;    % 角分辨光电子能谱
...
%% *************************************************************** %%
reflectivity1 = (Grazing_str2.R_intensity).^7.*Efficiency/200;    % 极紫外光学标定
reflectivity2 = (Grazing_str2.R_intensity).^6.*Grazing_str3.R_intensity.*Efficiency/200;    % 角分辨光电子能谱

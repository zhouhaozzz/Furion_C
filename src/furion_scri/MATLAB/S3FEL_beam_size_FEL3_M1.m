function  S3FEL_beam_size_FEL3_M1()
%% ******************************************************************** %%
...
subplot(1,2,1);
plot(wave_Lambda*1e9,out_SigmaI*2.355*1e6)
...
figure;
subplot(1,2,2);
plot(wave_Lambda(1:3)*1e9,2*out_SigmaI(1:3)*1e3/sin(14e-3))      % 2sigma
hold on
plot(wave_Lambda(1:3)*1e9,4*out_SigmaI(1:3)*1e3/sin(14e-3))      % 2sigma
hold on
plot(wave_Lambda(1:3)*1e9,6*out_SigmaI(1:3)*1e3/sin(14e-3))      % 2sigma
ylabel('Footprint$@\theta = 8.73 $mrad [mm]','interpreter','latex','FontSize',22);
xlabel('Wavelength [nm]','interpreter','latex','FontSize',22);
set(gcf,'Units','centimeters','Position',[10 10 40 15]);
set(gca,'TickLabelInterpreter','latex','fontsize',20,'linewidth',1.5);
set(get(gca,'Children'),'linewidth',2);
...
subplot(1,2,1);
plot(wave_Lambda(3:end)*1e9,2*out_SigmaI(3:end)*1e3/sin(25e-3))      % 2sigma
hold on
plot(wave_Lambda(3:end)*1e9,4*out_SigmaI(3:end)*1e3/sin(25e-3))      % 2sigma
hold on
plot(wave_Lambda(3:end)*1e9,6*out_SigmaI(3:end)*1e3/sin(25e-3))      % 2sigma
ylabel('Footprint$@\theta = 17.45 $mrad [mm]','interpreter','latex','FontSize',22);
xlabel('Wavelength [nm]','interpreter','latex','FontSize',22);
set(gcf,'Units','centimeters','Position',[10 10 40 15]);
set(gca,'TickLabelInterpreter','latex','fontsize',20,'linewidth',1.5);
set(get(gca,'Children'),'linewidth',2);
...
figure;
subplot(1,2,1)
plot(wave_Lambda*1e9,2*out_SigmaI*1e3/sin(17.45e-3))      % 2sigma
hold on
plot(wave_Lambda*1e9,4*out_SigmaI*1e3/sin(17.45e-3))      % 4sigma
hold on
plot(wave_Lambda*1e9,6*out_SigmaI*1e3/sin(17.45e-3))      % 6sigma
ylabel('Beam size$@$M1 [mm]','interpreter','latex','FontSize',22);
xlabel('Wavelength [nm]','interpreter','latex','FontSize',22);
set(gcf,'Units','centimeters','Position',[10 10 40 15]);
set(gca,'TickLabelInterpreter','latex','fontsize',20,'linewidth',1.5);
...
subplot(1,2,2)
plot(wave_Lambda*1e9,2*out_SigmaI*1e3/sin(8.73e-3))      % 2sigma
hold on
plot(wave_Lambda*1e9,4*out_SigmaI*1e3/sin(8.73e-3))      % 4sigma
hold on
plot(wave_Lambda*1e9,6*out_SigmaI*1e3/sin(8.73e-3))      % 6sigma
ylabel('Beam size$@$M1 [mm]','interpreter','latex','FontSize',22);
xlabel('Wavelength [nm]','interpreter','latex','FontSize',22);
set(gcf,'Units','centimeters','Position',[10 10 40 15]);

function [] = S3FEL_herror_StrehlR_FEL2(N)
%% ******************************************************************** %%
...
format long
N = 8;
x = linspace(2.3e-9,15e-9,300);    %  wavelength
...
x = linspace(2.3e-9,15e-9,300);    %  wavelength
y1 = 8.73e-3;                      %  grazing angle
y2 = 17.45e-3;                     %  grazing angle
...
set(gca,'TickLabelInterpreter','latex','fontsize',20,'linewidth',1.5);
set(get(gca,'Children'),'linewidth',2);
legend({'$\alpha$ = 8.73 mrad','$\alpha$ = 17.45 mrad'}...

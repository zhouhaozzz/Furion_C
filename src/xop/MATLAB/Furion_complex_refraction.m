...
% Input:
%     pho_Energy: photon energy [eV] 数组
%     atomic_sym: Symbol of element (lowercase)字符
%     path_Str: 字符串
...
complex_Nn = 1+1/2*chi_Materi;               %   Complex index of refraction  n = 1-δ+iβ
delta_Comp = -1/2*real(chi_Materi);          %   delta δ
beta_Comp  = 1/2*imag(chi_Materi);           %   beta β
%*******************↓ ↓输出复折射率参数*****************************

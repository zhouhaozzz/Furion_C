...
#ifndef FUR_G_FURION__CYLINDER_PARABOLIC_COLLIMATION_MIRROR_H_
#define FUR_G_FURION__CYLINDER_PARABOLIC_COLLIMATION_MIRROR_H_
...
namespace Furion_NS
{
    ...
    public:
        ...
        G_Furion_Cyliner_Parabolic_Collimation_Mirror(G_Beam* beam_in, double ds, double di, double chi, double theta, No_Surfe* surface, double r1, double r2, Grating* grating);

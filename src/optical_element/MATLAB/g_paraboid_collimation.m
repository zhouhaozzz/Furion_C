classdef  g_paraboid_collimation< g_cyliner_parabolic_collimation%追迹phase转换成角度
  properties 

  end
methods
function obj = g_paraboid_collimation( beam_in,ds,di,chi,theta,surface,r1,grating)   
    obj=obj@g_cyliner_parabolic_collimation( beam_in,ds,di,chi,theta,surface,r1,grating) ;%输入参数给父类
end
end

...
void G_Oe::reflect(G_Beam* beam_in, double ds, double di, double chi, double theta)
{
    ...
    std::vector<double> L(this->n);
    std::vector<double> M(this->n);
    std::vector<double> N(this->n);
    ...
    this->L1 = std::vector<double>(beam_in->n);
    this->M1 = std::vector<double>(beam_in->n);
    this->N1 = std::vector<double>(beam_in->n);
    this->X1 = std::vector<double>(beam_in->n);
    this->Y1 = std::vector<double>(beam_in->n);
    this->Z1 = std::vector<double>(beam_in->n);
    ...
    std::vector<double> T = std::vector<double>(this->n);
    this->X2 = std::vector<double>(beam_in->n);
    this->Y2 = std::vector<double>(beam_in->n);
    this->Z2 = std::vector<double>(beam_in->n);
    ...
    //std::vector<double> Nx(this->n);          //Nx == L  Save on memory management
    //std::vector<double> Ny(this->n);          //Ny == M
    //std::vector<double> Nz(this->n);          //Nz == N
    //normal(Nx, Ny, Nz);                                   //mormal Find reflection vector
    normal(L, N, M);                                   //mormal Find reflection vector

    //double* hslope = new double[this->n];
    std::vector<double> hslope(this->n);
    ...
    std::vector<double> L2(this->n);
    std::vector<double> M2(this->n);
    std::vector<double> N2(this->n);
    this->cos_Alpha = std::vector<double>(beam_in->n);
    f_r_v.Furion_reflect_Vector(this->cos_Alpha, L2, M2, N2, this->L1, this->M1, this->N1, L, M, N, grating->lambda_G, grating->m, grating->n0, grating->b, this->Z2, hslope, this->Cff, this->n);
    //destory_1d(Nx);
    //destory_1d(Ny);
    //destory_1d(Nz);
    //destory_1d(hslope);
    ...
    //std::vector<double> X3(this->n);      //X3 == Nx == L Save on memory management
    //std::vector<double> Y3(this->n);      //Y3 == Ny == M
    //std::vector<double> Z3(this->n);      //Z3 == Nz == N
    std::vector<double> L3(this->n);
    std::vector<double> N3(this->n);
    std::vector<double> M3(this->n);
    oe_to_image(L, M, N, L3, M3, N3, this->X2, this->Y2, this->Z2, di, L2, M2, N2);
    //destory_1d(L2);
    //destory_1d(M2);
    //destory_1d(N2);
    L2.clear();
    ...
    //std::vector<double> T1(this->n);
    this->X_ = std::vector<double>(this->n);
    this->Y_ = std::vector<double>(this->n);
    this->Phase = std::vector<double>(this->n);
    for (int i = 0; i < this->n; i++)
    {
        hslope[i] = -N[i] / N3[i];
        this->X_[i] = L[i] + hslope[i]*L3[i];
        this->Y_[i] = M[i] + hslope[i]*M3[i];
        this->Phase[i] = (T[i] + hslope[i]) / beam_in->lambda * 2 * _Pi - grating->n0 * grating->m * 2 * _Pi * Z2[i] - 0.5 * grating->m * grating->b * grating->n0 * 2 * _Pi * (Z2[i] * Z2[i]);
    }
    //destory_1d(X3);
    //destory_1d(Y3);
    //destory_1d(Z3);
    ...
    this->PSI = std::vector<double>(beam_in->n);
    this->PHI = std::vector<double>(beam_in->n);
...
void G_Oe::source_to_oe(std::vector<double>& X, std::vector<double>& Y, double ds, std::vector<double>& L, std::vector<double>& M, std::vector<double>& N)
{
    int n = this->n;
...
void G_Oe::matrixMulti(std::vector<double>& L2, std::vector<double>& M2, std::vector<double>& N2, std::vector<double>& matrix, std::vector<double>& L, std::vector<double>& M, std::vector<double>& N, double dx, int n)  //XYZ:1*3; LMN:1*n
{
    for (int i = 0; i < n; i++)
    {
...
void G_Oe::matrixMulti33(std::vector<double>& matrix, std::vector<double>& matrix1, std::vector<double>& matrix2)  //XYZ:1*3; LMN:1*n
{
    for (int i = 0; i < 3; i++)
    {
...
void G_Oe::matrixMulti0(std::vector<double>& L2, std::vector<double>& M2, std::vector<double>& N2, std::vector<double>& matrix, std::vector<double>& L, std::vector<double>& M, std::vector<double>& N, int n)  //XYZ:1*3; LMN:1*n
{
    for (int i = 0; i < n; i++)
    {
...
void G_Oe::intersection(std::vector<double>& T)
{
    int n = this->n;
...
void G_Oe::normal(std::vector<double>& Nx, std::vector<double>& Ny, std::vector<double>& Nz)
{
    int n = this->n;
...
void G_Oe::h_slope(std::vector<double>& h_slope, std::vector<double>& Y2)
{
    int n = this->n;
    ...
    std::vector<double> delta_Z1(n);
    std::vector<double> delta_Z(n);
...
void G_Oe::oe_to_image(std::vector<double>& X3, std::vector<double>& Y3, std::vector<double>& Z3, std::vector<double>& L3, std::vector<double>& M3, std::vector<double>& N3, std::vector<double>& X2, std::vector<double>& Y2, std::vector<double>& Z2, double di, std::vector<double>& L2, std::vector<double>& M2, std::vector<double>& N2)
{
    int n = this->n;
